...
plusieurs raisons :
 ...
 - version d'Elasticsearch utilisée 6.2.4, les query ne sont pas toutes valides avec les versions antérieurs 
   à cause d'un changement de syntaxe 